...
if np_baseball.shape[0] > 50:
    print("2 - Các giá trị của dòng thứ 50:", np_baseball[49])
else:
    print("2 - Không có dòng thứ 50 trong dữ liệu.")

#  3
np_weight = np_baseball[:, 1]
print("3 - np_weight (cân nặng của các cầu thủ):", np_weight)

#  4
if np_baseball.shape[0] > 124:
    chieu_cao_vd_124 = np_baseball[123, 0]
    print("4 - Chiều cao của vận động viên thứ 124:", chieu_cao_vd_124)
else:
    print("4 - Không có vận động viên thứ 124 trong dữ liệu.")

#  5
chieu_cao_trung_binh = np.mean(np_baseball[:, 0])
can_nang_trung_binh = np.mean(np_weight)
print("5 - Chiều cao trung bình của các cầu thủ:", chieu_cao_trung_binh)
...
print("6 - Hệ số tương quan giữa chiều cao và cân nặng:", correlation)
